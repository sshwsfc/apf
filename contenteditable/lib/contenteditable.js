...
var ContentEditable = function() {
    ...
    this.$propHandlers["editable"] = function(value, prop){
        ...
        if (value) {
            ...
            if (!ContentEditable.inited && this.parentNode.nodeType == 9) {
            ...
            if (this.$canEdit && this.$ext && !this.$coreHtml) {
                ...
                if (rInfo = this.ownerDocument.queryCommandEnabled("rename", false, this)) {
                    ...
                    if (apf.isIE)
                        htmlNode.ondblclick = ContentEditable.$renameStart;
                    else {
                        amlCore.addListener(htmlNode, "mousedown", 
                          ContentEditable.$renameStart);
                    }
                    
                    this.addEventListener("$skinchange", 
                        ContentEditable.$renameSkinChange);
                }
                ...
                //Drag & Resize
                ContentEditable.addInteraction(this);
            }
            ...
            if (this.$canEdit && this.$ext && !this.$coreHtml) {
                ...
                ContentEditable.removeInteraction(this);
...
ContentEditable.$contextMenu = function(e){
...
(function(){
    var time;
    ContentEditable.$renameStart = apf.isIE
      ? function(){
        e = event;
...
ContentEditable.$renameSkinChange = function(e){
