...
var DOMElement = function(struct, tagName){
    ...
    this.$init(function(tagName, nodeFunc, struct){
         ...
         * Possible values:
         * this.NODE_VISIBLE     this element has a gui representation
         * this.NODE_HIDDEN      this element does not display a gui
         */
...
(function(){
    ...
    this.$propertyHandler = function(prop, value, force){
        ...
        return (handler = this.$propHandlers && this.$propHandlers[prop]
          || this.nodeFunc == this.NODE_VISIBLE && apf.GuiElement && apf.GuiElement.propHandlers[prop] || null)
