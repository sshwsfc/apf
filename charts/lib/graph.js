    ...
    this.$drawGraph = function( v, doresize ){
		...
		if(this.$docompile){
           ...
           if(!this.$_style)this.$_style = 
                    apf.draw.parseStyle( chartDraw['_'+mode], this.style+this.$styletag, err );
            ...
            //alert(this.$datatype);
			this.$datatype = chartDraw['dt_'+this.$datamode+this.dataslice](this);
			this.$drawCode  = chartDraw[mode]( this, this.$datatype, this.$_style );
