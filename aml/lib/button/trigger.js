 ...
 *
 * @constructor
 * @define button, trigger, trigger, reset
 * @addnode elements
 *
 ...
 */
function trigger(struct, tagName){
    button.call(this, struct, tagName || "trigger");
};
trigger.prototype = button.prototype;
return aml.setElement("trigger",  trigger);
