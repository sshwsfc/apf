...
(function(){
    ...
    /**
     * @attribute {Boolean} iframe     whether this element is rendered inside an iframe. This is only supported for IE. Default is false for datagrid and true for spreadsheet and propgrid.
     */
     ...
     * consists of descriptions of columns (or rows for propgrid) for which
    ...
    */
    ...
    /**
     * Forces propgrid to wait for the load of a new property definition
     */
...
}).call(apf.propgrid.prototype = new apf.DataBinding());
/* #else
}).call(apf.propgrid.prototype = new apf.Presentation());
#endif*/

apf.aml.setElement("propgrid",    apf.propgrid);
