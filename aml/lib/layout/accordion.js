 ...
 * @since       2.2
 */
var Accordion = function(struct, tagName){
    Presentation.call(this, tagName || "accordion", this.NODE_VISIBLE, struct);
...
oop.inherit(Accordion, Presentation);
