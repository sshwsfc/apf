...
var validator = {
    ...
    compile : function(options){
        var m = this.macro, s = ["var temp, valid = true; \
            if (!validityState) \
                validityState = new validator.validityState(); "];
 ...
 */
validator.validityState = function(){
...
var Validation = function(){
    ...
    this.$propHandlers["validgroup"] = function(value){
        if (value) {
            ...
            this.$validgroup = vgroup || new ValidationGroup(value);
...
//#ifdef __PARSER_XSD
GuiElement.propHandlers["datatype"]   =
//#endif
GuiElement.propHandlers["required"]   = 
GuiElement.propHandlers["pattern"]    = 
GuiElement.propHandlers["min"]        = 
GuiElement.propHandlers["max"]        = 
GuiElement.propHandlers["maxlength"]  = 
GuiElement.propHandlers["minlength"]  = 
GuiElement.propHandlers["notnull"]    = 
GuiElement.propHandlers["checkequal"] = 
GuiElement.propHandlers["validtest"]  = function(value, prop){
    this.implement(Validation);
