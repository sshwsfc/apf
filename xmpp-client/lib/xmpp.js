...
(function() {
    ...
    this.reset = function() {
        ...
        this.setProperty(CONN, false);
        // #ifdef __TP_XMPP_ROSTER
        this.$serverVars[ROSTER]   = new XmppRoster(this.model,
                    ...
                    switch (aX[k].getAttribute("xmlns")) {
                        case constants.NS.muc_user:
                            if (this.$getStatusCode(aX[k], 201)) {
                                this.$mucSignal(XmppMuc.ROOM_CREATE, sJID);
                                break;
                            }
                            ...
                            this.$mucSignal(XmppMuc.ROOM_JOINED, sRoom, {
                                fullJID    : sJID,
            ...
            for (var j = 0, l2 = aQueries.length; j < l2; j++) {
                ...
                switch (aQueries[j].getAttribute("xmlns")) {
                    ...
                    case constants.NS.disco_items:
                        ...
                        if (aErrors.length
                          && parseInt(aErrors[0].getAttribute("code")) == 404) {
                            ...
                            this.$mucSignal(XmppMuc.ROOM_NOTFOUND, sFrom);
                            break;
                        }
                        ...
                        this.$mucSignal(XmppMuc.ROOM_EXISTS, sFrom);
                    ...
                    case constants.NS.muc_owner:
                        this.$mucSignal(XmppMuc.ROOM_CREATE, sFrom);
                        break;
                    // #ifdef __WITH_RDB
