...
var XmppMuc = function(){
    ...
    this.$mucSignal = function(iType, sRoom, oData) {
        ...
        delete mucVars[f];
        switch (iType) {
            case XmppMuc.ROOM_CREATE:
            case XmppMuc.ROOM_EXISTS:
                if (typeof cb == "function")
                    cb(true);
                break;
            case XmppMuc.ROOM_NOTFOUND:
                if (typeof cb == "function")
                    cb(false);
                break;
            case XmppMuc.ROOM_JOINED:
            case XmppMuc.ROOM_LEFT:
...
XmppMuc.ROOM_CREATE    = 1;
XmppMuc.ROOM_EXISTS    = 2;
XmppMuc.ROOM_NOTFOUND  = 3;
XmppMuc.ROOM_JOINED    = 4;
XmppMuc.ROOM_LEFT      = 5;
XmppMuc.ROOM_RDB       = 6;

XmppMuc.ACTION_SUBJECT = 0x0001;
XmppMuc.ACTION_KICK    = 0x0002;
XmppMuc.ACTION_BAN     = 0x0004;
