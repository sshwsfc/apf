 ...
 * @return {XmppRdb} A new XMPP RDB object
 * @type {Object}
 * @constructor
 */
var XmppRdb = function(){
    var _self     = this,
        rdbVars   = {"SID":0},
        docQueue  = [],
        syncQueue = [],
...
XmppRdb.DOC_CREATE    = 1;
XmppRdb.DOC_EXISTS    = 2;
XmppRdb.DOC_NOTFOUND  = 3;
XmppRdb.DOC_JOINED    = 4;
XmppRdb.DOC_LEFT      = 5;
XmppRdb.DOC_RDB       = 6;

XmppRdb.ACTION_SUBJECT = 0x0001;
XmppRdb.ACTION_KICK    = 0x0002;
XmppRdb.ACTION_BAN     = 0x0004;
