...
var hook = {
    ...
    hookWrap : function ( func, onlyasync ){
        if(func._outer) 
            return func._outer;
        var names;
    ...
    hookPre : function ( func, forcesync, cb){
    ...
    hookPost : function ( func, forcesync, cb){
        var hooked = func._inner?func:(forcesync?apf.hookWrapSync(func):apf.hookWrap(func));
    ...
    hookArgDump : function(data,names,opts){
    ...
    hookFormat : function(func, pre, format, name, module, forcesync, outputcb) {
