 ...
 * @since       0.8
 */
var xsd = parser.setNamespace("http://www.w3.org/2001/XInclude", new namespace());
...
xsd.custumTypeHandlers = {};

xsd.matchType = function(value, type){
...
xsd.checkType = function(type, xmlNode){
